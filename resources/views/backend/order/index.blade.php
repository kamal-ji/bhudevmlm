        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                        ...
                        <div>
							<a href="{{route('orders.create')}}" class="btn btn-primary d-flex align-items-center">
								<i class="isax isax-add-circle5 me-1"></i>Create Order
							</a>
						</div>
					</div>
    </div>
                ...
                "dataSrc": function(json) {
                    if (json.success) {
                        ...
                        var data = json.data.map(function(order) {
                            ...
                            var viewurl =
                                "{{ route('orders.view', ['order' => '__ID__']) }}";
...
switch(order.delivery_status) {
    case 'Delivered':
        status = '<span class="badge badge-soft-success d-inline-flex align-items-center">Delivered <i class="isax isax-tick-circle ms-1"></i></span>';
        break;
    case 'Confirmed':
        status = '<span class="badge badge-soft-success d-inline-flex align-items-center">Confirmed <i class="isax isax-tick-circle ms-1"></i></span>';
        break;
    case 'Shipped':
        ...
        break;
                            ...
                            return {
                                "checkbox": '<div class="form-check form-check-md"><input class="form-check-input row-checkbox" type="checkbox" value="' +
                                    ...
                                    order.name + '">' : 'No Image',
                                "order_no": '<a href="' + orderViewUrl + '" target="_blank">'+order.order_no+'</a>',
                                "date": order.date,
                                ...
                                "actions": '<a href="javascript:void(0);" data-bs-toggle="dropdown"><i class="isax isax-more"></i></a><ul class="dropdown-menu"><li><a href="' +
                                    orderViewUrl +
                                    '" class="dropdown-item d-flex align-items-center"><i class="isax isax-eye me-2 me-2"></i>Order detail</a></li></ul>'
