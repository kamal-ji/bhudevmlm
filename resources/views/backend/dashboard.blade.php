...
<div class="content">
    ...
    <div class="bg-primary rounded welcome-wrap position-relative mb-3">
                ...
                <div>
                    ...
                    if ($hour >= 5 && $hour < 12) { $wish="Good morning!" ; } elseif ($hour>= 12 && $hour < 17) {
                            $wish="Good afternoon!" ; } elseif ($hour>= 17 && $hour < 21) { $wish="Good evening!" ; }
                                else { $wish="Good night!" ; } @endphp <h5 class="text-white mb-1">{{$wish}},
                                {{ Session::get('external_user')['name'] ?? '' }}</h5>
        ...
        <div class="position-absolute end-0 top-50 translate-middle-y p-2 d-none d-sm-block">
            <img src="{{asset('assets/backend/img/icons/dashboard.svg')}}" alt="img">
        </div>
    </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-1"><a href="customer-details.html">Emily
                                                        Clark</a></h6>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-end gap-2">
                                            ...
                                            <div data-bs-toggle="tooltip" data-bs-title="Add Ledger">
                                                <a href="#" class="btn btn-icon btn-sm btn-light" data-bs-toggle="modal"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-1"><a href="customer-details.html">John
                                                        Smith</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-1"><a href="customer-details.html">Olivia
                                                        Harris</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-1"><a href="customer-details.html">William
                                                        Parker</a></h6>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-1"><a
                                                        href="customer-details.html">Charlotte Brown</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-0"><a href="customer-details.html">Emily
                                                        Clark</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-0"><a href="customer-details.html">John
                                                        Carter</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-0"><a href="customer-details.html">Sophia
                                                        White</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-0"><a href="customer-details.html">Michael
                                                        Johnson</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-0"><a href="customer-details.html">Daniel
                                                        Martinez</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="customer-details.html"
                                                class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                                <img src="assets/img/users/user-27.jpg" class="rounded-circle"
                                                    alt="img">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-0"><a href="customer-details.html">William
                                                        Parker</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="fs-14 fw-medium mb-0"><a href="customer-details.html">Mia
                                                        Thompson</a></h6>
                                            </div>
                                        </div>
                                    </td>
                ...
                <div class="card-body pb-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fs-14 fw-semibold mb-1"><a href="javascript:void(0);">Daniel Martinez</a>
                                </h6>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fs-14 fw-semibold mb-1"><a href="javascript:void(0);">Amelia Robinson</a>
                                </h6>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fs-14 fw-semibold mb-1"><a href="customer-details.html">David Anderson</a>
                                </h6>
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="fs-14 fw-semibold mb-1"><a href="customer-details.html">Michael Johnson</a>
                                </h6>
